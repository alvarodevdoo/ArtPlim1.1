...
import { Info, Check, X, Search, ChevronRight, ChevronDown, Loader2 } from 'lucide-react';
...
const ALL_ACCOUNTS: AccountEntry[] = [
  ...
  { id: '1.1.1.01', code: '1.1.1.01', name: 'Caixa', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.1.1', description: 'Dinheiro em espécie guardado na empresa.' },
  { id: '1.1.1.02', code: '1.1.1.02', name: 'Bancos Conta Movimento (Itaú, Nubank, etc.)', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.1.1', description: 'Saldos em contas bancárias correntes da empresa.' },
  { id: '1.1.1.03', code: '1.1.1.03', name: 'Aplicações Financeiras de Liquidez Imediata', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.1.1', description: 'Investimentos que podem ser resgatados a qualquer momento.' },
  ...
  { id: '1.1.2.01', code: '1.1.2.01', name: 'Clientes Nacionais', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.1.2', description: 'Valores que sua empresa tem a receber de clientes localizados no Brasil.' },
  { id: '1.1.2.02', code: '1.1.2.02', name: 'Cartões de Crédito a Receber', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.1.2', description: 'Vendas feitas no cartão que a operadora ainda vai depositar na sua conta.' },
  ...
  { id: '1.1.3.01', code: '1.1.3.01', name: 'Estoque de Mercadorias para Revenda', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.1.3', description: 'Itens que você comprou prontos para vender diretamente.' },
  { id: '1.1.3.02', code: '1.1.3.02', name: 'Estoque de Matéria-Prima (Papel, Tintas, Filamentos)', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.1.3', description: 'Materiais que serão usados para produzir seus itens ou serviços.' },
  { id: '1.1.3.03', code: '1.1.3.03', name: 'Estoque de Produtos Acabados', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.1.3', description: 'Itens que já estão prontos, aguardando entrega ou retirada.' },
  ...
  { id: '1.2.1.01', code: '1.2.1.01', name: 'Máquinas e Equipamentos (Impressoras, Maquinário)', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.2.1', description: 'Equipamentos físicos como máquinas e ferramentas de produção.' },
  { id: '1.2.1.02', code: '1.2.1.02', name: 'Móveis e Utensílios', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.2.1', description: 'Mobiliário da empresa como mesas, cadeiras e armários.' },
  { id: '1.2.1.03', code: '1.2.1.03', name: 'Veículos', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.2.1', description: 'Carros, motos ou vans usados na operação e entregas.' },
  { id: '1.2.1.04', code: '1.2.1.04', name: 'Equipamentos de Informática', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.2.1', description: 'Computadores, monitores, servidores e redes da empresa.' },
  ...
  { id: '1.2.2.01', code: '1.2.2.01', name: 'Softwares e Licenças', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.2.2', description: 'Licenças de programas e sistemas de gestão.' },
  { id: '1.2.2.02', code: '1.2.2.02', name: 'Marcas e Patentes', nature: 'ASSET', type: 'ANALYTIC', parentCode: '1.2.2', description: 'A proteção legal do nome e da logo da sua marca.' },
  // === 2. PASSIVO ===
  ...
  { id: '2.1.1.01', code: '2.1.1.01', name: 'Fornecedores Nacionais', nature: 'LIABILITY', type: 'ANALYTIC', parentCode: '2.1.1', description: 'Pagamentos devidos a distribuidores e fabricantes dentro do Brasil.' },
  ...
  { id: '2.1.2.01', code: '2.1.2.01', name: 'Salários e Ordenados a Pagar', nature: 'LIABILITY', type: 'ANALYTIC', parentCode: '2.1.2', description: 'A folha de pagamento do mês que ainda não foi quitada.' },
  { id: '2.1.2.02', code: '2.1.2.02', name: 'INSS a Recolher', nature: 'LIABILITY', type: 'ANALYTIC', parentCode: '2.1.2', description: 'A contribuição previdenciária descontada e devida ao governo.' },
  { id: '2.1.2.03', code: '2.1.2.03', name: 'FGTS a Recolher', nature: 'LIABILITY', type: 'ANALYTIC', parentCode: '2.1.2', description: 'O fundo de garantia obrigatório para cada colaborador.' },
  { id: '2.1.2.04', code: '2.1.2.04', name: 'Férias e 13º Salário a Pagar', nature: 'LIABILITY', type: 'ANALYTIC', parentCode: '2.1.2', description: 'Reserva para o pagamento dos direitos anuais dos funcionários.' },
  ...
  { id: '2.1.3.01', code: '2.1.3.01', name: 'Simples Nacional a Recolher', nature: 'LIABILITY', type: 'ANALYTIC', parentCode: '2.1.3', description: 'A guia unificada de impostos mensais da sua empresa.' },
  { id: '2.1.3.02', code: '2.1.3.02', name: 'ICMS / ISS a Recolher', nature: 'LIABILITY', type: 'ANALYTIC', parentCode: '2.1.3', description: 'Impostos estaduais (sobre produtos) e municipais (sobre serviços).' },
  ...
  { id: '2.2.1.01', code: '2.2.1.01', name: 'Financiamentos de Máquinas/Veículos', nature: 'LIABILITY', type: 'ANALYTIC', parentCode: '2.2.1', description: 'Parcelas de financiamento ou leasing de bens de grande porte.' },
  { id: '2.2.1.02', code: '2.2.1.02', name: 'Empréstimos Bancários a Longo Prazo', nature: 'LIABILITY', type: 'ANALYTIC', parentCode: '2.2.1', description: 'Linhas de crédito para investimento parceladas em muitos meses.' },
  ...
  { id: '2.3.1.01', code: '2.3.1.01', name: 'Capital Social Subscrito/Integralizado', nature: 'EQUITY', type: 'ANALYTIC', parentCode: '2.3.1', description: 'O valor exato registrado no contrato social da empresa.' },
  ...
  { id: '2.3.2.01', code: '2.3.2.01', name: 'Lucros ou Prejuízos Acumulados', nature: 'EQUITY', type: 'ANALYTIC', parentCode: '2.3.2', description: 'A soma dos resultados (positivo ou negativo) de todos os anos.' },
  // === 3. RECEITAS ===
  ...
  { id: '3.1.1.01', code: '3.1.1.01', name: 'Receita com Venda de Produtos Acabados', nature: 'REVENUE', type: 'ANALYTIC', parentCode: '3.1.1', description: 'Dinheiro vindo da venda de itens que você mesmo produz.' },
  { id: '3.1.1.02', code: '3.1.1.02', name: 'Receita com Venda de Mercadorias', nature: 'REVENUE', type: 'ANALYTIC', parentCode: '3.1.1', description: 'Dinheiro vindo da revenda de itens comprados prontos.' },
  { id: '3.1.1.03', code: '3.1.1.03', name: 'Receita com Prestação de Serviços', nature: 'REVENUE', type: 'ANALYTIC', parentCode: '3.1.1', description: 'Ganhos com mão de obra, instalações ou consultoria técnica.' },
  ...
  { id: '3.2.1.01', code: '3.2.1.01', name: 'Simples Nacional sobre Vendas', nature: 'REVENUE_DEDUCTION', type: 'ANALYTIC', parentCode: '3.2.1', description: 'A porcentagem fixa do Simples Nacional calculada sobre as vendas.' },
  { id: '3.2.1.02', code: '3.2.1.02', name: 'ICMS / ISS sobre Vendas', nature: 'REVENUE_DEDUCTION', type: 'ANALYTIC', parentCode: '3.2.1', description: 'Impostos estaduais e municipais específicos recolhidos sobre o faturamento.' },
  ...
  { id: '3.2.2.01', code: '3.2.2.01', name: 'Devoluções de Vendas', nature: 'REVENUE_DEDUCTION', type: 'ANALYTIC', parentCode: '3.2.2', description: 'Quando o cliente devolve o produto e você gera um estorno.' },
  { id: '3.2.2.02', code: '3.2.2.02', name: 'Descontos Incondicionais Concedidos', nature: 'REVENUE_DEDUCTION', type: 'ANALYTIC', parentCode: '3.2.2', description: 'Descontos dados no momento da venda (no boleto ou nota).' },
  // === 4. CUSTOS ===
  ...
  { id: '4.1.1.01', code: '4.1.1.01', name: 'Custo com Matéria-Prima', nature: 'COST', type: 'ANALYTIC', parentCode: '4.1.1', description: 'Investimento em materiais e insumos básicos usados na produção.' },
  { id: '4.1.1.02', code: '4.1.1.02', name: 'Custo com Embalagens', nature: 'COST', type: 'ANALYTIC', parentCode: '4.1.1', description: 'Materiais para proteger seu produto como plásticos, caixas e fitas.' },
  { id: '4.1.1.03', code: '4.1.1.03', name: 'Mão de Obra Direta (Produção)', nature: 'COST', type: 'ANALYTIC', parentCode: '4.1.1', description: 'O salário dos profissionais que atuam diretamente na produção.' },
  { id: '4.1.1.04', code: '4.1.1.04', name: 'Custos Indiretos de Fabricação (Energia, manutenção)', nature: 'COST', type: 'ANALYTIC', parentCode: '4.1.1', description: 'Gastos como a energia elétrica operacional e reparo de maquinário.' },
  ...
  { id: '4.1.2.01', code: '4.1.2.01', name: 'Material Aplicado nos Serviços', nature: 'COST', type: 'ANALYTIC', parentCode: '4.1.2', description: 'Materiais secundários e insumos usados especificamente em serviços executados.' },
  // === 5. DESPESAS ===
  ...
  { id: '5.1.1.01', code: '5.1.1.01', name: 'Pró-labore dos Sócios', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.1', description: 'O valor mensal fixo retirado pelos donos pelo trabalho na empresa.' },
  { id: '5.1.1.02', code: '5.1.1.02', name: 'Aluguel e Condomínio', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.1', description: 'Custo do imóvel (ponto comercial) onde a empresa está instalada.' },
  { id: '5.1.1.03', code: '5.1.1.03', name: 'Água, Luz e Telefone/Internet', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.1', description: 'Contas de consumo básico para manter a estrutura mínima do negócio.' },
  { id: '5.1.1.04', code: '5.1.1.04', name: 'Honorários Contábeis e Jurídicos', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.1', description: 'Pagamento mensal do seu contador ou assessoria jurídica.' },
  { id: '5.1.1.05', code: '5.1.1.05', name: 'Material de Escritório e Limpeza', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.1', description: 'Gastos com papelaria interna, café e produtos de limpeza do estabelecimento.' },
  ...
  { id: '5.1.2.01', code: '5.1.2.01', name: 'Comissões sobre Vendas', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.2', description: 'Percentual do faturamento pago aos seus vendedores.' },
  { id: '5.1.2.02', code: '5.1.2.02', name: 'Marketing e Publicidade', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.2', description: 'Anúncios no Instagram/Google e confecção de portfólios da empresa.' },
  { id: '5.1.2.03', code: '5.1.2.03', name: 'Fretes e Entregas', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.2', description: 'Gasto com motoboys ou transportadoras para fazer chegar o pedido ao cliente.' },
  ...
  { id: '5.1.3.01', code: '5.1.3.01', name: 'Tarifas Bancárias e Taxas de Boletos', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.3', description: 'Manutenção de conta e custos para emissão e liquidação de boletos.' },
  { id: '5.1.3.02', code: '5.1.3.02', name: 'Taxas de Máquinas de Cartão', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.3', description: 'O percentual de desconto das operadoras de cartão em cada venda.' },
  { id: '5.1.3.03', code: '5.1.3.03', name: 'Juros e Multas Pagos', nature: 'EXPENSE', type: 'ANALYTIC', parentCode: '5.1.3', description: 'Gastos extras decorrentes do atraso no pagamento de boletos ou impostos.' },
  ...
  { id: '6.1.1.01', code: '6.1.1.01', name: 'Apuração do Resultado (ARE)', nature: 'RESULT_CALCULATION', type: 'ANALYTIC', parentCode: '6.1.1', description: 'Registro técnico contábil do fechamento anual das contas.' },
  ...
  { id: '9.1.1.01', code: '9.1.1.01', name: 'Bens de Terceiros em Nosso Poder', nature: 'CONTROL', type: 'ANALYTIC', parentCode: '9.1.1', description: 'Amostras de prova, máquinas em comodato ou arquivos em custódia.' },
  ...
  { id: '9.2.1.01', code: '9.2.1.01', name: 'Contrapartida de Bens de Terceiros', nature: 'CONTROL', type: 'ANALYTIC', parentCode: '9.2.1', description: 'Lançamento que anula o valor dos bens para não inflar seu patrimônio real.' },
];
...
export const DefaultChartOfAccountsModal: React.FC<DefaultChartOfAccountsModalProps> = ({ onClose, onSuccess }) => {
  ...
  const [selectedIds, setSelectedIds] = useState<Set<string>>(new Set()); // Iniciar com tudo fechado por padrão para facilitar a visualização
  ...
  useEffect(() => {
    const fetchExisting = async () => {
      try {
        ...
        // Flat collection of ALL existing codes from the tree
        ...
        setSelectedIds(new Set(ALL_ACCOUNTS.map(a => a.id)));
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const toggleAccount = (acc: AccountEntry) => {
    if (existingCodes.has(acc.code)) return; // locked
  ...
  const newToImportCount = [...selectedIds].filter(id => {
    ...
    return acc && !existingCodes.has(acc.code);
  }).length;

  const handleSelectAll = () => {
    const allSelectable = ALL_ACCOUNTS.filter(a => !existingCodes.has(a.code)).map(a => a.id);
  ...
  const handleImport = async () => {
    const toImport = ALL_ACCOUNTS.filter(a => selectedIds.has(a.id) && !existingCodes.has(a.code));
        ...
        <CardHeader className="bg-slate-50 border-b shrink-0 flex flex-row items-start justify-between">
          <div>
            ...
            <CardDescription className="mt-1">
              Estrutura contábil <strong>completa SPED (9 naturezas)</strong>, otimizada para Gráfica e Papelaria.
        ...
        <CardContent className="overflow-y-auto overflow-x-hidden p-4 space-y-2">
          {isLoading ? (
            ...
            <>
              ...
              const selectedInGroup = groupAccounts.filter(a => selectedIds.has(a.id) || existingCodes.has(a.code)).length;
                  ...
                  {expanded && (
                    <div className="divide-y bg-white">
                      {groupAccounts.map(acc => {
                        ...
                        const isExisting = existingCodes.has(acc.code);
                        ...
                        return (
                          ...
                          >
                            ...
                            />
                            <span className={`font-mono text-xs w-24 shrink-0 ${isExisting ? 'text-slate-300' : 'text-slate-400'}`}>
                              {acc.code}
                            </span>
                            <span className={`text-sm flex-1 ${isSynthetic ? 'font-semibold' : ''} ${isExisting ? 'text-slate-400 line-through' : 'text-slate-700'} flex items-center gap-2 group/help relative`}>
                              {acc.name}
                              {acc.description && (
                            ...
                            {isExisting ? (
                              <span className="text-[9px] px-1.5 py-0.5 rounded bg-slate-100 text-slate-400 uppercase font-bold shrink-0">
                                Já existe
                              </span>
                            ) : (
                              <span className={`text-[9px] px-1.5 py-0.5 rounded uppercase font-bold shrink-0 ${isSynthetic ? 'bg-slate-100 text-slate-500' : 'bg-white border border-slate-200 text-slate-400'}`}>
                                {isSynthetic ? '[S]' : '[A]'}
                              </span>
                            )}
                          </div>
