...
const createProfileSchema = z.object({
  ...
  email: z.string().nullable().transform(val => val?.trim() || null).refine(val => !val || z.string().email().safeParse(val).success, 'Email inválido'),
  phone: z.string().nullable().transform(val => val?.trim() || null),
  address: z.string().nullable().transform(val => val?.trim() || null),
  city: z.string().nullable().transform(val => val?.trim() || null),
  state: z.string().nullable().transform(val => val?.trim() || null),
  zipCode: z.string().nullable().transform(val => val?.trim() || null),
