...
describe('ProductComponentService', () => {
  ...
  describe('Property Tests', () => {
     ...
     */
    test('Feature: product-material-integration, Property 1: Component Addition Consistency', () => {
     ...
     */
    test('Feature: product-material-integration, Property 3: Component Removal Consistency', () => {
      fc.assert(fc.property(
        fc.record({
          productId: fc.uuid(),
          componentId: fc.uuid(),
     ...
     */
    test('Feature: product-material-integration, Property 2: Material Validation Rules', () => {
      fc.assert(fc.property(
        fc.record({
          materialId: fc.uuid(),
          materialFormat: fc.constantFrom(MaterialFormat.SHEET, MaterialFormat.ROLL, MaterialFormat.UNIT),
