...
- **Responsabilidades**:
  - Validação de permissão de edição (apenas DRAFT)
...
- **APPROVED**: Aprovado pelo cliente - inicia produção
- **IN_PRODUCTION**: Em produção - não pode ser cancelado
- **FINISHED**: Produção finalizada - pronto para entrega
- **DELIVERED**: Entregue ao cliente - processo completo
- **CANCELLED**: Cancelado - processo interrompido
