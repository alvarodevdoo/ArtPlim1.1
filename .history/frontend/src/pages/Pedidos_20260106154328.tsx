                            ...
                            <div className="flex justify-between items-start">
                              <div className="flex-1">
                                ...
                                <div className="mt-2 grid grid-cols-2 gap-4 text-sm">
                                  ...
                                  <p><span className="font-medium">Área:</span> {((item.width * item.height) / 1000000).toFixed(2)} m²</p>
                                  <p><span className="font-medium">Área Total:</span> {((item.width * item.height * item.quantity) / 1000000).toFixed(2)} m²</p>
                                </div>
                                {item.notes && (
                              ...
                              <div className="text-right ml-4">
                                <p className="font-medium">{formatCurrency(item.unitPrice)}/un</p>
