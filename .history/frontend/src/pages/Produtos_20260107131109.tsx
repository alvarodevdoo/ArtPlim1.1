            ...
            <CardContent>
              <div className="space-y-2">
                ...
                <div className="pt-2 border-t">
                  ...
                  {/* Debug: mostrar se não tem componentes */}
                  {(!produto.components || produto.components.length === 0) && produto.name.toLowerCase().includes('cartão') && (
                    <div className="flex items-center space-x-1">
                      <span className="text-xs text-red-600 font-medium">
                        ⚠️ Sem materiais (Debug: {JSON.stringify(produto.components)})
                      </span>
                    </div>
                  )}
                  </div>
