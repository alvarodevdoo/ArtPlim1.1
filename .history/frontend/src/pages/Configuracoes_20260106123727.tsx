                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className={`flex items-center justify-between p-3 border rounded-lg ${
                        settings.enableEngineering ? 'border-green-200 bg-green-50' : 'border-border'
                      }`}>
                        <div>
                      ...
                      <div className={`flex items-center justify-between p-3 border rounded-lg ${
                        settings.enableWMS ? 'border-green-200 bg-green-50' : 'border-border'
                      }`}>
                        <div>
                          <h5 className="font-medium flex items-center space-x-2">
                      ...
                      <div className={`flex items-center justify-between p-3 border rounded-lg ${
                        settings.enableProduction ? 'border-green-200 bg-green-50' : 'border-border'
                      }`}>
                        <div>
                          <h5 className="font-medium flex items-center space-x-2">
                      ...
                      <div className={`flex items-center justify-between p-3 border rounded-lg ${
                        settings.enableFinance ? 'border-green-200 bg-green-50' : 'border-border'
                      }`}>
                        <div>
                          <h5 className="font-medium flex items-center space-x-2">
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p className="text-sm">Gerenciamento completo de usuários em breve</p>
                  </div>
                </div>
              </CardContent>
            </Card>
