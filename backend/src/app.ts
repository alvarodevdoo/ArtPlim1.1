...
async function registerRoutes() {
  ...
  await fastify.register(async function (fastify) {
    // Usar rotas otimizadas quando disponíveis
    await fastify.register(salesRoutesOptimized, { prefix: '/sales' });
    await fastify.register(catalogRoutesOptimized, { prefix: '/catalog' });
    await fastify.register(profilesRoutesOptimized, { prefix: '/profiles' });
