...
import { performanceMiddleware, PerformanceMonitor } from './shared/infrastructure/http/middleware/performanceMiddleware';
...
// Middleware de performance (antes das rotas)
...
app.get('/api/admin/performance', authMiddleware, async (req: any, res) => {
  try {
...
httpServer.listen(PORT, () => {
  // Limpar terminal após inicialização
  //console.clear();
